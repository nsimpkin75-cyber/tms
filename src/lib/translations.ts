...
export const translations: Record<Language, Translations> = {
  'en-GB': {
    ...
    navigation: {
      ...
      competencyFramework: 'Value Framework',
      copilot: 'Copilot',
      admin: 'Admin',
    },
    admin: {
    ...
    competency: {
      ...
      description: 'Manage organisational values, values, and Target Behaviour Levels',
      newValue: 'New Value',
      editValue: 'Edit Value',
      valueTitle: 'Value Title',
      valueStatement: 'Value Statement',
      sortOrder: 'Sort Order',
      addCompetency: 'Add Value',
      newCompetency: 'New Value',
      editCompetency: 'Edit Value',
      competencyTitle: 'Value Title',
      ...
      noCompetencies: 'No values yet. Add a value to get started.',
      noLevels: 'No levels defined. Add levels to describe target behaviour progression.',
      selectValue: 'Select a value to view and manage values',
      emoji: 'Emoji',
      competenciesCount: 'values',
      levelsDefined: 'levels defined',
      deleteValueConfirm: 'Are you sure? This will delete all related values and levels.',
  ...
  'en-US': {
    ...
    competency: {
      title: 'Value Framework',
      description: 'Manage organizational values, values, and Target Behavior Levels',
      newValue: 'New Value',
      editValue: 'Edit Value',
      valueTitle: 'Value Title',
      valueStatement: 'Value Statement',
